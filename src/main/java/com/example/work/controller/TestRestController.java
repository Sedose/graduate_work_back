...
public class TestRestController {
    ...
    @GetMapping("/id")
    @PreAuthorize("hasAuthority('developerRequestBodies:read')")
    public DeveloperRequestBody getById(@PathVariable Long id) {
        return developerRequestBodies.stream()
                .filter(developerRequestBody -> developerRequestBody.getId().equals(id))
                .findFirst()
